...
public class TicTacTae extends JButton implements ActionListener {
    JButton squares[];
     ...
     * @paramпередается X – для пользователя и O – для компа
     */
